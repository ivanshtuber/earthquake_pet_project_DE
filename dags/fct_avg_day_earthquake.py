...
1. Удаляет таблицу "stg.fct_avg_day_earthquake"
2. Создает таблицу stg.fct_avg_day_earthquake  с одной записью содержащие новые данные
3. Удаляет записи из таблицы  dm.fct_avg_day_earthquake совпадающие по полю date c stg.fct_avg_day_earthquake
4. Добовляет запись из stg.fct_avg_day_earthquake в dm.fct_avg_day_earthquake
5. Удаляет таблицу "stg.fct_avg_day_earthquake" 
"""

SHORT_DESCRIPTION = "Заполняет таблицу dm.fct_avg_day_earthquake"
